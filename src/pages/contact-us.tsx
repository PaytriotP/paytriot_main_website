            ...
            <div className="text-center mb-5">
              <div className="d-inline-flex align-items-center justify-content-center mb-3">
                ...
                <div className="fs-2 fw-bold">
                  ...
                  <span className="text-dark">triot</span>
                </div>
              </div>
                ...
                <div className="w-100">
                  ...
                  >
                    <div className="card-body text-center p-4">
                      <div className="contact-wrap d-flex flex-column align-items-center">
                        <div className="contact-icon mb-4 p-3 rounded-3 shadow-sm" style={{ backgroundColor: "white" }}>
                          <Image
                        ...
                        <p className="p-14 text-opacity text-center mb-4 lh-lg">
                          The Charter Building, <br />
                          Charter Place, <br />
                          Uxbridge, <br />
                          UB8 1JG
