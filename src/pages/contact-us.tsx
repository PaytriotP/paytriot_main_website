...
export default function ContactUs() {
  ...
  return (
    <>
      ...
      <main style={{ background: "rgb(var(--background-start-rgb))" }}>
        <style jsx>{`
          .enhanced-card {
          ...
          <div className="container">
            ...
            <div className="text-center mb-5">
              <div className="d-inline-flex align-items-center justify-content-center mb-3">
                <div
                  className="rounded-3 d-flex align-items-center justify-content-center me-3 gradient-bg"
                  style={{ width: "60px", height: "60px" }}
                >
                  <span className="text-white fw-bold fs-4">P</span>
                </div>
                <div className="fs-2 fw-bold">
                  <span style={{ color: "#E67E22" }}>pay</span>
                  <span style={{ color: "rgb(var(--foreground-rgb))" }}>triot</span>
                </div>
              </div>
              <h1 className="text-center display-4 fw-bold mb-3" style={{ color: "rgb(var(--foreground-rgb))" }}>
                Contact Us
              </h1>
            ...
            <div className="row g-4">
              ...
              <div className="col-lg-8">
                <div className="enhanced-card shadow-lg h-100">
                  <div className="card-body p-4">
                    <div className="mb-4">
                      <h2 className="card-title fs-3 fw-bold mb-2" style={{ color: "rgb(var(--foreground-rgb))" }}>
                        Send us a message
                      </h2>
                    ...
                    <div className="row g-3 mb-4">
                      <div className="col-md-4">
                        <div className="text-center p-3 trust-indicator">
                          <i className="fas fa-clock fs-5 mb-2" style={{ color: "#E67E22" }}></i>
                          <p className="small fw-semibold mb-1" style={{ color: "rgb(var(--foreground-rgb))" }}>
                            24hr Response
                          </p>
              ...
              <div className="col-lg-4 d-flex justify-content-center">
                <div className="w-100">
                  {/* Address Card */}
                  <div className="enhanced-card shadow-lg mb-4">
                    <div className="card-body text-center p-4">
                      <div className="contact-wrap d-flex flex-column align-items-center">
                        <div
                          className="contact-icon mb-4 p-3 shadow-sm"
                          style={{
                        ...
                        <h4 className="mb-3 text-center fw-bold" style={{ color: "rgb(var(--foreground-rgb))" }}>
                          Address
                        </h4>
                        ...
                        <Button
                          ...
                          color="warning"
                          onClick={openGoogleMaps}
                          className="shadow-sm gradient-bg"
                          style={{ border: "none" }}
                        >
                      ...
                      <div className="mt-4 pt-4 border-top">
                        <div className="d-flex align-items-center mb-3">
                          ...
                          <div className="text-start">
                            <p className="fw-semibold mb-0 small" style={{ color: "rgb(var(--foreground-rgb))" }}>
                              Email Us
                            </p>
                  ...
                  {/* Trust Badge */}
                  <div className="card border-0 shadow-lg text-white gradient-bg">
                    <div className="card-body text-center p-4">
                      <div
